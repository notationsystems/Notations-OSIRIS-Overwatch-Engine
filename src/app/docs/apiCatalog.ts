...
export const API_GROUPS: ApiGroup[] = [
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        env: ['PAYLOAD_CORPUS_DATABASE_PATH', 'PAYLOAD_CORPUS_READ_MODEL_PATH', 'PAYLOAD_CORPUS_QUERY_TOKEN'],
        requiresAuth: true,
      ...
      },
      {
        ...
        env: ['PAYLOAD_CORPUS_DATABASE_PATH', 'PAYLOAD_CORPUS_PROJECTOR_TOKEN'],
        requiresAuth: true,

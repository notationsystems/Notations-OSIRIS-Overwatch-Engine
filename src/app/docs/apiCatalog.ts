...
export const API_GROUPS: ApiGroup[] = [
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        notes: 'Requires the dedicated corpus-administration bearer token. A successful POST includes a deterministic builder manifest covering only the canonical write performed; it does not falsely attest to upstream acquisition or extraction. Exact replay is idempotent and immutable identity conflicts are refused.',
      ...
      },
      {
        ...
        env: ['PAYLOAD_CORPUS_DATABASE_PATH', 'PAYLOAD_CORPUS_READ_MODEL_PATH', 'PAYLOAD_CORPUS_PATTERN_REGISTRY_PATH', 'PAYLOAD_CORPUS_MINER_TOKEN'],
        requiresAuth: true,

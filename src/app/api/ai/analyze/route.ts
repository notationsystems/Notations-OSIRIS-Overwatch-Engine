/**
 * ═══════════════════════════════════════════════════════════════
 *  Payload — AI Intelligence Analysis Endpoint
 *  POST /api/ai/analyze
...
export async function POST(
  ...
  if (!isRouteEnabled('ai/analyze')) {
    return NextResponse.json(routeRetiredPayload('ai/analyze'), { status: 503 }) as never;
  }
  ...
  try {
    ...
    console.error('[Payload Terminal AI] Analysis error:', message);
    return NextResponse.json(

...
/**
 * Payload — Real-Time Geopolitical Events (GDELT 2.0 GeoJSON API)
...
export async function GET() {
  try {
    ...
    for (const rawItem of rawItems) {
      ...
      // Map GDACS event types to Payload Terminal types. WF and DR used to fall through
    ...
    console.error('[Payload Terminal] GDACS fetch error:', error);

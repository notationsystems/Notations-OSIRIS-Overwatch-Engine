/**
 * ═══════════════════════════════════════════════════════════════
 *  Payload — AI Intelligence Engine
...
const SYSTEM_PROMPT = `You are Payload Terminal Intelligence Analyst — a senior, elite intelligence analyst embedded within the Payload Terminal Global Intelligence Platform. You operate at the level of a Palantir Forward Deployed Engineer crossed with a CIA PDB (Presidential Daily Brief) analyst.
...
You have access to the live intelligence context of the Payload Terminal platform. Analyze it with precision.`;

const BRIEFING_PROMPT = `Generate a comprehensive Payload Terminal Daily Intelligence Briefing based on the current operational data. Structure it as follows:

## Payload Terminal INTELLIGENCE BRIEFING

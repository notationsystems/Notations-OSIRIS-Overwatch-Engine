...
carries its **class** (`entityAttestation`): the strongest evidence class
among an entity's attesting records — strongest, not weakest, because one
reported record proves an identity is more than curation however many
